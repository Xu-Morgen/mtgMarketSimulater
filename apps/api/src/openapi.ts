 ...
 */
export const publicApiPaths = ["/health", "/ready", "/openapi.json", "/v1/market/quote-preview", "/v1/auth/register", "/v1/auth/login", "/v1/auth/refresh", "/v1/auth/logout", "/v1/auth/session", "/v1/archive", "/v1/account", "/v1/ledger", "/v1/catalog/cards", "/v1/catalog/cards/{skuId}", "/v1/catalog/images/{imageName}", "/v1/packs", "/v1/packs/{packId}", "/v1/admin/jobs", "/v1/admin/jobs/{id}/retry", "/v1/admin/catalog/sync"] as const;
...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/v1/packs": { get: { summary: "公示补充包价格、启用状态和版本化卡位概率", responses: { "200": { description: "补充包列表" }, "401": { description: "认证无效或过期" } } } },
    "/v1/packs/{packId}": { get: { summary: "查询单个补充包的服务端概率配置", responses: { "200": { description: "补充包详情" }, "404": { description: "补充包不存在" } } } },
