...
function safeNext(next: string | null, role: "player" | "admin") { if (next?.startsWith("/") && !next.startsWith("//") && (role === "admin" || !next.startsWith("/admin"))) return next; return role === "admin" ? "/admin" : "/dashboard"; }
